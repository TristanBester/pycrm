...
from experiments.warehouse.lib.machines.reward import (
    create_constant_reward,
    create_penalty_waypoint_reward,
    create_waypoint_reward,
)
from experiments.warehouse.lib.machines.stage.transition import Transition
...
def create_grip_stage(
    ...
    transitions.append(
        Transition(
            ...
            reward_fn=create_constant_reward(0.0, enable_rescaling=True),
        )
    )
    # Other
    transitions.append(

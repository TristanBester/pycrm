...
class RegularLoggingWrapper(gym.Wrapper):
    ...
    def _get_subtask_info(self) -> dict:
        ...
        return {
            "subtask/cube_3/above_complete_3": int(self._above_complete_3),
            "subtask/cube_2/above_complete_2": int(self._above_complete_2),
            "subtask/cube_1/above_complete_1": int(self._above_complete_1),
            "subtask/cube_3/grasp_complete_3": int(self._grasp_complete_3),
            "subtask/cube_2/grasp_complete_2": int(self._grasp_complete_2),
            "subtask/cube_1/grasp_complete_1": int(self._grasp_complete_1),
            "subtask/cube_3/grip_complete_3": int(self._grip_complete_3),
            "subtask/cube_2/grip_complete_2": int(self._grip_complete_2),
            "subtask/cube_1/grip_complete_1": int(self._grip_complete_1),
            "subtask/cube_3/release_complete_3": int(self._release_complete_3),
            "subtask/cube_2/release_complete_2": int(self._release_complete_2),
            "subtask/cube_1/release_complete_1": int(self._release_complete_1),
            "subtask/cube_3/drop_complete_3": int(self._drop_complete_3),
            "subtask/cube_2/drop_complete_2": int(self._drop_complete_2),
            "subtask/cube_1/drop_complete_1": int(self._drop_complete_1),
            "red/complete_3": int(self._red_complete_3),
            "red/complete_2": int(self._red_complete_2),
            "red/complete_1": int(self._red_complete_1),
        }
...
class ContextFreeLoggingWrapper(gym.Wrapper):
    ...
    def _get_subtask_info(self) -> dict:
        ...
        return {
            ...
            "red/complete_2": int(self._red_complete_2),
            "red/complete_1": int(self._red_complete_1),
            "green/complete_3": int(self._green_complete_3),
            "green/complete_2": int(self._green_complete_2),
            "green/complete_1": int(self._green_complete_1),
        }
...
class ContextSensitiveLoggingWrapper(gym.Wrapper):
    ...
    def _get_subtask_info(self) -> dict:
        ...
        return {
            ...
            "green/complete_2": int(self._green_complete_2),
            "green/complete_1": int(self._green_complete_1),
            "blue/complete_3": int(self._blue_complete_3),
            "blue/complete_2": int(self._blue_complete_2),
            "blue/complete_1": int(self._blue_complete_1),
        }

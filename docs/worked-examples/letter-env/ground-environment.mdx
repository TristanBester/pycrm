...
- Learn about the [Labelling Function](/docs/worked-examples/letter-env/labelling-function) that maps environment states to symbolic events
- Explore how the [Counting Reward Machine](/docs/worked-examples/letter-env/crm) defines rewards based on these events

---
title: 'Counterfactual Q-Learning'
...
You can find the complete source code for this example in the repository:

- [Counterfactual Q-Learning Implementation (cq_learning.py)](https://github.com/tmrob2/counting-reward-machines/blob/main/examples/letter/cq_learning.py)
- [Q-Learning Implementation (q_learning.py)](https://github.com/tmrob2/counting-reward-machines/blob/main/examples/letter/q_learning.py)
- [Letter World Environment (ground.py)](https://github.com/tmrob2/counting-reward-machines/blob/main/examples/letter/core/ground.py)
- [Labelling Function (label.py)](https://github.com/tmrob2/counting-reward-machines/blob/main/examples/letter/core/label.py)
- [Counting Reward Machine (machine.py)](https://github.com/tmrob2/counting-reward-machines/blob/main/examples/letter/core/machine.py)
- [Cross-Product Environment (crossproduct.py)](https://github.com/tmrob2/counting-reward-machines/blob/main/examples/letter/core/crossproduct.py)

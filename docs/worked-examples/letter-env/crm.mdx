...
- Learn about [Q-Learning with CRMs](/docs/worked-examples/letter-env/q-learning)
- Explore [Counterfactual Q-Learning](/docs/worked-examples/letter-env/counterfactual-q-learning) for more efficient learning

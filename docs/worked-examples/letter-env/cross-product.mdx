...
- [environment_example.py](https://github.com/TristanBester/counting-reward-machines/blob/main/examples/letter/environment_example.py)
- [Letter World Core Components](https://github.com/TristanBester/counting-reward-machines/tree/main/examples/letter/core)

Feel free to experiment with it and adapt it to your own reinforcement learning tasks!
